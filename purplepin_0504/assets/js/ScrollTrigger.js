...
$(function(){
    ...
    $(window).scroll(function() {
        ...
        if ( scroll = headpage ) {						
			$('.arrow-box').addClass('first-page');				
        }
        else {            
			$('.arrow-box').removeClass('first-page');  	      			
			$('.arrow-box').removeClass('last-page');  	      			
        }
    });
...
$(function(){
    var footPage =  window.innerHeight * 5; 
    $(window).scroll(function() {
        var scroll = getCurrentScroll();
        if ( scroll = footPage ) {			
			$('.arrow-box').addClass('last-page');   			
        }
        else {            			      				
			$('.arrow-box').removeClass('first-page');  
			$('.arrow-box').addClass('last-page'); 
